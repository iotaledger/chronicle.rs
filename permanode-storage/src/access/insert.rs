...
impl Insert<MessageId, Message> for Mainnet {
        ...
        Self: Insert<MessageId, Message>,
    {
        ...
        let query = Execute::new()
            .id(&self.insert_id::<MessageId, Message>())
...
impl Insert<Bee<MessageId>, Bee<Message>> for Mainnet {
    fn statement(&self) -> std::borrow::Cow<'static, str> {
        format!(
            "INSERT INTO {}.messages (message_id, message) VALUES (?, ?)",
            self.name()
        ...
        Self: Insert<Bee<MessageId>, Bee<Message>>,
    {
        ...
        let query = Execute::new()
            .id(&self.insert_id::<Bee<MessageId>, Bee<Message>>())
            .consistency(scylla_cql::Consistency::One)
            .value(&message_id_bytes.as_slice())
            .value(&message_bytes.as_slice())
            .build();
...
impl Insert<Bee<MessageId>, Bee<MessageMetadata>> for Mainnet {
    fn statement(&self) -> std::borrow::Cow<'static, str> {
        format!(
        ...
        Self: Insert<Bee<MessageId>, Bee<MessageMetadata>>,
    {
        ...
        let query = Execute::new()
            .id(&self.insert_id::<Bee<MessageId>, Bee<MessageMetadata>>())
            .consistency(scylla_cql::Consistency::One)
            .value(&message_id_bytes.as_slice())
...
impl Insert<Bee<MessageId>, (Bee<Message>, Bee<MessageMetadata>)> for Mainnet {
    fn statement(&self) -> std::borrow::Cow<'static, str> {
        format!(
        ...
        Self: Insert<Bee<MessageId>, (Bee<Message>, Bee<MessageMetadata>)>,
    {
        ...
        let query = Execute::new()
            .id(&self.insert_id::<Bee<MessageId>, (Bee<Message>, Bee<MessageMetadata>)>())
            .consistency(scylla_cql::Consistency::One)
            .value(&message_id_bytes.as_slice())
            .value(&message_bytes.as_slice())
            .value(&metadata_bytes.as_slice())
...
impl Insert<Bee<MilestoneIndex>, Bee<Milestone>> for Mainnet {
    fn statement(&self) -> std::borrow::Cow<'static, str> {
        format!(
        ...
        Self: Insert<Bee<MilestoneIndex>, Bee<Milestone>>,
    {
        ...
        let query = Execute::new()
            .id(&self.insert_id::<Bee<MilestoneIndex>, Bee<Milestone>>())
            .consistency(scylla_cql::Consistency::One)
...
impl Insert<Bee<HashedIndex>, Bee<MessageId>> for Mainnet {
    fn statement(&self) -> std::borrow::Cow<'static, str> {
        format!(
        ...
        Self: Insert<Bee<HashedIndex>, Bee<MessageId>>,
    {
        ...
        let query = Execute::new()
            .id(&self.insert_id::<Bee<HashedIndex>, Bee<MessageId>>())
            .consistency(scylla_cql::Consistency::One)
            .value(&key.as_ref())
            .value(&0u16)
            .value(&message_id_bytes.as_slice())
