...
actor!(CqlQueryIdBuilder { statement: String });

impl CqlQueryIdBuilder {
...
async fn delay_for_10_sec() {
    println!("Sleep Begin");
    let five_seconds = Duration::new(10, 0);
...
async fn main() {
    ...
    AppsBuilder::new()
        ...
        .future(|apps| async {
            ...
            // do test like launching async worker and await till it finish
            // builder it first and then
            CqlQueryIdBuilder::new()
            ...
            CqlQueryIdBuilder::new()
                ...
                .run()
                .await;
            // Note: Need to change the file path if the program not running under chronicle.rs folder
            InsertTransactionsFromFileBuilder::new()
                .filepath("./chronicle-example/dmp/18675_head10.dmp".to_string())
