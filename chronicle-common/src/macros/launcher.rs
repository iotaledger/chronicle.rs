...
//! This module implements launcher macro.

#[macro_export]
/// A launcher launches and handles multiple applications with redefined behaviors/events.
macro_rules! launcher {
    ...
    (
        ...
        impl $apps {
            ...
            pub async fn future<F>(mut self, f: impl Fn($apps) -> F) -> Self
